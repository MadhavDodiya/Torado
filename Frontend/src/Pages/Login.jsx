    ...
    <>
      <section className="relative w-full overflow-hidden">
        <div className="grid min-h-[360px] lg:grid-cols-2">
          <div className="relative flex items-center overflow-hidden bg-[#0d1e35] px-10 py-20 lg:px-16">
            <span className="pointer-events-none absolute left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-1/2 select-none whitespace-nowrap text-[3rem] font-black uppercase tracking-widest text-white/[0.06] lg:text-[6rem]">
              Login
            </span>
          ...
          <div className="relative min-h-[220px] overflow-hidden">
            <img src={heroImg} alt="Login background" className="block h-full w-full object-cover object-top" />
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-16">
        <div className="mx-auto w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
          <h2 className="mb-6 text-center text-3xl font-bold text-[#0d1e35]">Welcome Back</h2>
          ...
          <p className="mt-5 text-center text-sm text-slate-600">
            ...
            <Link to="/register" className="font-bold text-red-500 no-underline hover:text-red-600">Register</Link>
          </p>
        </div>
      </section>
    </>
